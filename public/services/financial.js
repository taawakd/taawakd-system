...
[صيغة إلزامية: فعل (خفّض/ارفع/أوقف/عدّل) + **${_bpTop1.label}** + الرقم الحالي (${_bpTop1.sar.toLocaleString('en')} ريال/شهر) + الهدف المطلوب بالريال + الإجراء المحدد]
مثال صحيح: "خفّض ${_bpTop1.label} من ${_bpTop1.sar.toLocaleString('en')} إلى [هدف واقعي ≤ 20% أقل] ريال/شهر عبر [إجراء محدد قابل للتنفيذ]"`
  : '[افعل/أوقف/ارفع/خفّض] [ماذا بالضبط] [بكم] [خلال كم يوم].'}
...
✅ القرار الصحيح: [فعل] + [${_bpTop1 ? _bpTop1.label : 'البند #1'}] + [${_bpTop1 ? _bpTop1.sar.toLocaleString('en') + ' ريال → هدف' : 'الرقم الحالي → الهدف'}] + [الإجراء المحدد].
...
[صيغة إلزامية: فعل (خفّض/ارفع/أوقف/عدّل) + **${_top1.label}** + الرقم الحالي (${fmtN(_top1.sar)} ريال) + الهدف المطلوب بالريال + الإجراء المحدد]
مثال صحيح: "خفّض ${_top1.label} من ${fmtN(_top1.sar)} إلى [هدف واقعي ≤ 20% أقل] ريال عبر [إجراء محدد قابل للتنفيذ]"`
  : '[افعل/أوقف/ارفع/خفّض] [ماذا بالضبط] [بكم] [خلال كم يوم].'}
...
✅ القرار الصحيح: [فعل] + [${_top1 ? _top1.label : 'العامل #1'}] + [${_top1 ? fmtN(_top1.sar) + ' ريال → هدف' : 'الرقم الحالي → الهدف'}] + [الإجراء المحدد].
