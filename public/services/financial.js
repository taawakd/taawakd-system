...
⚠️ قاعدة إلزامية لنقطة التعادل:
❌ يُمنع إعادة حساب نقطة التعادل إذا كانت القيمة موجودة أعلاه (${fmtN(latest.breakEven)} ريال).
✅ عند السؤال عن "الحد الأدنى للإيرادات" أو "نقطة التعادل": أجب بـ ${fmtN(latest.breakEven)} ريال مباشرة.
...
✅ أعِد الحساب فقط إذا تغيّر بند مالي بطلب صريح من المستخدم.
