...
══ قاعدة حساب نقطة التعادل بالوحدات ══
إذا طلب المستخدم عدد الوحدات اللازمة للوصول إلى نقطة التعادل، استخدم هذه المعادلة حصراً:
  نقطة التعادل (بالوحدات) = التكاليف الثابتة ÷ (سعر البيع − التكلفة الكاملة للوحدة)
حيث:
  الربح لكل وحدة = سعر البيع − التكلفة الكاملة للوحدة
  التكاليف الثابتة = الأرقام الواردة في قسم "نقطة التعادل" أعلاه
❌ لا تقسم التكلفة الكاملة على نفسها.
❌ لا تستخدم الإيرادات الكلية أو متوسط السعر بديلاً عن ربح الوحدة.
✅ إذا توفرت بيانات المنتج في قسم "بيانات المنتجات الحالية"، استخدم سعره وتكلفته مباشرة في المعادلة.
