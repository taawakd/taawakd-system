...
// ── تصنيفات المنتجات/الخدمات — مخصصة لكل نوع نشاط تجاري ────────────────
// يمنع ظهور تصنيفات المطاعم في أنشطة أخرى (حلاقة، صيدلية، إلخ)
const _MENU_CATEGORIES_MAP = {
  // مطاعم وكافيهات
  restaurant:    ['','مقبلات','طاسات وشوربات','مشويات','رئيسية','سلطات','وجبات جانبية','مشروبات باردة','مشروبات ساخنة','عصائر','حلويات','إضافات','وجبات خاصة','أطفال','إفطار','غداء','عشاء','أخرى'],
  cafe:          ['','مشروبات ساخنة','مشروبات باردة','عصائر','سموذي','مثلجات','حلويات','وجبات خفيفة','باستا وسندويتشات','إضافات','أخرى'],
  cloud_kitchen: ['','وجبات رئيسية','وجبات صحية','بروتين','سلطات','مشروبات','وجبات جانبية','ديسرت','أخرى'],
  drive_thru:    ['','مشروبات ساخنة','مشروبات باردة','عصائر','مخبوزات','حلويات','وجبات خفيفة','إضافات','أخرى'],
  bakery:        ['','خبز وأرغفة','كرواسون ومعجنات','كيك وتورتات','حلويات شرقية','بسكويت وكوكيز','مشروبات','طلبات خاصة','أخرى'],
  juice_kiosk:   ['','عصائر طازجة','سموذي','مثلجات وشيك','عصائر اجتماعي','إضافات','أخرى'],

  // خدمات شخصية
  barber:        ['','قص وتشكيل','حلاقة ذقن','عناية بالشعر','أطفال','عروس وعريس','باقات','إضافات','أخرى'],
  beauty:        ['','شعر','مكياج','عناية بالبشرة','أظافر','جسم وسبا','عروس','باقات','أخرى'],
  clinic:        ['','استشارة','فحص وتشخيص','إجراء طبي','جلسة علاجية','تحليل مختبري','أشعة','أخرى'],
  laundry:       ['','غسيل عادي','تنظيف جاف','كوي','غسيل سريع','غسيل فندقي','مفروشات','أخرى'],
  carwash:       ['','غسيل خارجي','غسيل داخلي','غسيل كامل','تلميع وحماية','إضافات','أخرى'],
  fitness:       ['','اشتراك شهري','اشتراك سنوي','اشتراك يومي','دروس خاصة','دروس جماعية','باقات','أخرى'],
  spa:           ['','مساج','عناية بالوجه','عناية بالجسم','حمام بخار','جاكوزي','باقات','أخرى'],
  pet:           ['','استشارة','تطعيم','علاج','حمام وتزيين','إيواء','إكسسوارات','أخرى'],

  // تجزئة ومبيعات
  retail:        ['','منتجات رئيسية','عروض وتخفيضات','وصل حديثاً','الأكثر مبيعاً','إضافات وملحقات','أخرى'],
  pharmacy:      ['','أدوية','مستلزمات طبية','مكملات ومنشطات','عناية بالبشرة','أجهزة طبية','أخرى'],
  perfumes:      ['','رجالي','نسائي','عطور عود','عطور عربية','عطور غربية','هدايا وباقات','أخرى'],
  dates:         ['','تمور فاخرة','تمور هدايا','تمور بالكيلو','منتجات مشتقة','تمور محشية','أخرى'],
  ecom:          ['','منتجات رئيسية','عروض','وصل حديثاً','الأكثر مبيعاً','ملحقات','أخرى'],

  // خدمات مهنية
  services:      ['','استشارة','مشروع','دراسة أو تقرير','تصميم','برمجة','تدريب','أخرى'],
  services_co:   ['','خدمة أساسية','باقة متكاملة','مشروع','صيانة','دعم فني','تدريب','أخرى'],
  tech:          ['','تطوير ويب','تطوير تطبيق','استشارة تقنية','دعم فني','اشتراك','ترخيص','أخرى'],
  logistics:     ['','توصيل سريع','توصيل اقتصادي','شحن دولي','خدمة الكميات','تخزين','أخرى'],
  hotel:         ['','غرف سياحية','غرف تنفيذية','أجنحة','إقامة طويلة','خدمات إضافية','أخرى'],
  education:     ['','دورة أساسية','دورة متقدمة','جلسة خاصة','باقات','شهادة','أخرى'],
  photography:   ['','تصوير جلسة','تصوير مناسبات','أعراس','منتجات وإعلان','تصوير هواء','أخرى'],
  event:         ['','تنظيم حفل','ديكور وتنسيق','تغذية','تصوير','صوت وإضاءة','أخرى'],

  // احتياطي عام
  other:         ['','خدمة أساسية','خدمة إضافية','باقة','عرض خاص','أخرى'],
};

/**
 * _getMenuCategories(bizType)
 * ─────────────────────────────
 * يُعيد قائمة تصنيفات مناسبة لنوع النشاط التجاري.
 * يمنع ظهور تصنيفات المطاعم في أنشطة الحلاقة والصيدلة وغيرها.
 */
function _getMenuCategories(bizType) {
  const cats = _MENU_CATEGORIES_MAP[bizType] || _MENU_CATEGORIES_MAP['other'];
  console.log('[Tawakkad][menuCategories] biz_type=%s → %d categories loaded', bizType, cats.length - 1);
  return cats;
}
...
function _menuCreateRow(name, price, cost, category) {
  ...
  // استخدم التصنيفات المناسبة لنوع النشاط التجاري الحالي
  const _currentBizType = window._businessProfile?.biz_type || 'other';
  const _dynamicCats = _getMenuCategories(_currentBizType);
  const catOptions = _dynamicCats.map(c =>
